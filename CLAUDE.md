...
- **Still deferred**: structured certifications (agency/date per cert, not one string), gear locker, dive statistics beyond the manual count, connected services, real photo upload (avatar is a pasted URL for now, no upload endpoint).
