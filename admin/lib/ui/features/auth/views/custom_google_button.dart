...
/// real button. So this renders the real button, sized to match, but made almost fully
/// transparent (`opacity: 0.01` — not 0, since some browsers treat a fully-invisible
/// element's click as untrusted/synthetic and Google's own SDK rejects it) and stacks it
/// on TOP of a purely decorative, `IgnorePointer`-wrapped copy of our own button style
/// underneath. Every real click still lands on Google's real button and goes through the
/// same OAuth flow; only the paint layer is ours. Same technique ForeignReader's own web
