/// photoUrl/verified are read-only here — photo upload isn't ported to admin/'s simplified Account page, so there's no client-side mutation path for them.
class SpecialtyCertification {
  ...
  /// "Other" pairs with customLabel as the real display name; every other type's own name is already the label.
