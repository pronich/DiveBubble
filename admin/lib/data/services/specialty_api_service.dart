...
class SpecialtyApiService {
  ...
  Future<List<SpecialtyCertification>> fetchSpecialties() async {
    ...
    return list.map((e) => SpecialtyCertification.fromJson(e as Map<String, dynamic>)).toList();
  }
  ...
  Future<SpecialtyCertification> addSpecialty({
    ...
    return SpecialtyCertification.fromJson(jsonDecode(res.body) as Map<String, dynamic>);
  }

  Future<void> removeSpecialty(String id) async {
    final res = await _client.delete(Uri.parse('$baseUrl/me/specialties/$id'), headers: await _authHeaders());
