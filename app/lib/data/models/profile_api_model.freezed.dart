...
@override
String toString() {
  return 'ProfileApiModel(id: $id, displayName: $displayName, avatarUrl: $avatarUrl, location: $location, bio: $bio, diveCount: $diveCount, certificationLevel: $certificationLevel, languages: $languages, memberSince: $memberSince)';
}
...
class _ProfileApiModel implements ProfileApiModel {
  const _ProfileApiModel({required this.id, this.displayName, this.avatarUrl, this.location, this.bio, this.diveCount = 0, this.certificationLevel, this.languages = '', required this.memberSince});
