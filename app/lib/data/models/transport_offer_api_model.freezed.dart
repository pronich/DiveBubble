...
@override
String toString() {
  return 'TransportOfferApiModel(id: $id, tripId: $tripId, userId: $userId, type: $type, seats: $seats, details: $details, createdAt: $createdAt)';
}
...
class _TransportOfferApiModel implements TransportOfferApiModel {
  const _TransportOfferApiModel({required this.id, required this.tripId, required this.userId, required this.type, this.seats, this.details, required this.createdAt});
