...
mixin _$TransportOfferApiModel {
 ...
 String get id; String get tripId; String get userId; String get type; int? get seats; String? get details; DateTime get createdAt; int get joinedCount; bool get joined; bool get isDiveCenterStaff; bool get hasUnreadMessages;
...
@override
String toString() {
  return 'TransportOfferApiModel(id: $id, tripId: $tripId, userId: $userId, type: $type, seats: $seats, details: $details, createdAt: $createdAt, joinedCount: $joinedCount, joined: $joined, isDiveCenterStaff: $isDiveCenterStaff, hasUnreadMessages: $hasUnreadMessages)';
}
...
class _TransportOfferApiModel implements TransportOfferApiModel {
  const _TransportOfferApiModel({required this.id, required this.tripId, required this.userId, required this.type, this.seats, this.details, required this.createdAt, this.joinedCount = 0, this.joined = false, this.isDiveCenterStaff = false, this.hasUnreadMessages = false});
