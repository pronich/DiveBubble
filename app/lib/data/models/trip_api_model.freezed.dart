...
mixin _$TripApiModel {
 ...
 String get id; String get title; String get location; DateTime get startTime; DateTime get createdAt; bool get joined; String? get creatorUserId; int get participantCount; int get unreadCount; bool get hasTransportAlert; bool get hasBuddyAlert; DateTime? get endDate; String? get description; String? get meetingPoint; int? get diveCountMin; int? get diveCountMax; int? get depthMinM; int? get depthMaxM; String? get minCertification; String? get bookingCode; int? get maxParticipants; String get bookingStatus; bool get isPrivate; String? get photoUrl; String? get diveCenterId; int? get priceMinor; String get currency; String? get bookingUrl; double? get latitude; double? get longitude;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,location,startTime,createdAt,joined,creatorUserId,participantCount,unreadCount,hasTransportAlert,hasBuddyAlert,endDate,description,meetingPoint,diveCountMin,diveCountMax,depthMinM,depthMaxM,minCertification,bookingCode,maxParticipants,bookingStatus,isPrivate,photoUrl,diveCenterId,priceMinor,currency,bookingUrl,latitude,longitude]);

@override
String toString() {
  return 'TripApiModel(id: $id, title: $title, location: $location, startTime: $startTime, createdAt: $createdAt, joined: $joined, creatorUserId: $creatorUserId, participantCount: $participantCount, unreadCount: $unreadCount, hasTransportAlert: $hasTransportAlert, hasBuddyAlert: $hasBuddyAlert, endDate: $endDate, description: $description, meetingPoint: $meetingPoint, diveCountMin: $diveCountMin, diveCountMax: $diveCountMax, depthMinM: $depthMinM, depthMaxM: $depthMaxM, minCertification: $minCertification, bookingCode: $bookingCode, maxParticipants: $maxParticipants, bookingStatus: $bookingStatus, isPrivate: $isPrivate, photoUrl: $photoUrl, diveCenterId: $diveCenterId, priceMinor: $priceMinor, currency: $currency, bookingUrl: $bookingUrl, latitude: $latitude, longitude: $longitude)';
}
...
@useResult
$Res call({
 String id, String title, String location, DateTime startTime, DateTime createdAt, bool joined, String? creatorUserId, int participantCount, int unreadCount, bool hasTransportAlert, bool hasBuddyAlert, DateTime? endDate, String? description, String? meetingPoint, int? diveCountMin, int? diveCountMax, int? depthMinM, int? depthMaxM, String? minCertification, String? bookingCode, int? maxParticipants, String bookingStatus, bool isPrivate, String? photoUrl, String? diveCenterId, int? priceMinor, String currency, String? bookingUrl, double? latitude, double? longitude
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String location,  DateTime startTime,  DateTime createdAt,  bool joined,  String? creatorUserId,  int participantCount,  int unreadCount,  bool hasTransportAlert,  bool hasBuddyAlert,  DateTime? endDate,  String? description,  String? meetingPoint,  int? diveCountMin,  int? diveCountMax,  int? depthMinM,  int? depthMaxM,  String? minCertification,  String? bookingCode,  int? maxParticipants,  String bookingStatus,  bool isPrivate,  String? photoUrl,  String? diveCenterId,  int? priceMinor,  String currency,  String? bookingUrl,  double? latitude,  double? longitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TripApiModel() when $default != null:
return $default(_that.id,_that.title,_that.location,_that.startTime,_that.createdAt,_that.joined,_that.creatorUserId,_that.participantCount,_that.unreadCount,_that.hasTransportAlert,_that.hasBuddyAlert,_that.endDate,_that.description,_that.meetingPoint,_that.diveCountMin,_that.diveCountMax,_that.depthMinM,_that.depthMaxM,_that.minCertification,_that.bookingCode,_that.maxParticipants,_that.bookingStatus,_that.isPrivate,_that.photoUrl,_that.diveCenterId,_that.priceMinor,_that.currency,_that.bookingUrl,_that.latitude,_that.longitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String location,  DateTime startTime,  DateTime createdAt,  bool joined,  String? creatorUserId,  int participantCount,  int unreadCount,  bool hasTransportAlert,  bool hasBuddyAlert,  DateTime? endDate,  String? description,  String? meetingPoint,  int? diveCountMin,  int? diveCountMax,  int? depthMinM,  int? depthMaxM,  String? minCertification,  String? bookingCode,  int? maxParticipants,  String bookingStatus,  bool isPrivate,  String? photoUrl,  String? diveCenterId,  int? priceMinor,  String currency,  String? bookingUrl,  double? latitude,  double? longitude)  $default,) {final _that = this;
switch (_that) {
case _TripApiModel():
return $default(_that.id,_that.title,_that.location,_that.startTime,_that.createdAt,_that.joined,_that.creatorUserId,_that.participantCount,_that.unreadCount,_that.hasTransportAlert,_that.hasBuddyAlert,_that.endDate,_that.description,_that.meetingPoint,_that.diveCountMin,_that.diveCountMax,_that.depthMinM,_that.depthMaxM,_that.minCertification,_that.bookingCode,_that.maxParticipants,_that.bookingStatus,_that.isPrivate,_that.photoUrl,_that.diveCenterId,_that.priceMinor,_that.currency,_that.bookingUrl,_that.latitude,_that.longitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String location,  DateTime startTime,  DateTime createdAt,  bool joined,  String? creatorUserId,  int participantCount,  int unreadCount,  bool hasTransportAlert,  bool hasBuddyAlert,  DateTime? endDate,  String? description,  String? meetingPoint,  int? diveCountMin,  int? diveCountMax,  int? depthMinM,  int? depthMaxM,  String? minCertification,  String? bookingCode,  int? maxParticipants,  String bookingStatus,  bool isPrivate,  String? photoUrl,  String? diveCenterId,  int? priceMinor,  String currency,  String? bookingUrl,  double? latitude,  double? longitude)?  $default,) {final _that = this;
switch (_that) {
case _TripApiModel() when $default != null:
return $default(_that.id,_that.title,_that.location,_that.startTime,_that.createdAt,_that.joined,_that.creatorUserId,_that.participantCount,_that.unreadCount,_that.hasTransportAlert,_that.hasBuddyAlert,_that.endDate,_that.description,_that.meetingPoint,_that.diveCountMin,_that.diveCountMax,_that.depthMinM,_that.depthMaxM,_that.minCertification,_that.bookingCode,_that.maxParticipants,_that.bookingStatus,_that.isPrivate,_that.photoUrl,_that.diveCenterId,_that.priceMinor,_that.currency,_that.bookingUrl,_that.latitude,_that.longitude);case _:
  return null;
...
class _TripApiModel implements TripApiModel {
  const _TripApiModel({required this.id, required this.title, required this.location, required this.startTime, required this.createdAt, required this.joined, this.creatorUserId, this.participantCount = 0, this.unreadCount = 0, this.hasTransportAlert = false, this.hasBuddyAlert = false, this.endDate, this.description, this.meetingPoint, this.diveCountMin, this.diveCountMax, this.depthMinM, this.depthMaxM, this.minCertification, this.bookingCode, this.maxParticipants, this.bookingStatus = 'open', this.isPrivate = false, this.photoUrl, this.diveCenterId, this.priceMinor, this.currency = 'DKK', this.bookingUrl, this.latitude, this.longitude});
