...
class PhotoManagerItem {
  ...
  /// Shows a spinner over the tile instead of the delete button.
  final bool isBusy;
}

/// Used both for Create Trip's not-yet-uploaded local picks and an existing trip's uploaded gallery — the caller decides what "add"/"remove" actually do.
