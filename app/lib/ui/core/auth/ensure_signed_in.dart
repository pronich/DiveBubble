...
Future<String?> ensureSignedIn(BuildContext context, AuthRepository authRepository) async {
  ...
  final signedIn = await LoginSheet.show(context, authRepository: authRepository);
