...
mixin _$Trip {
 ...
 String get id; String get title; String get location; DateTime get startTime; bool get joined; String? get creatorUserId; int get participantCount; int get unreadCount;// A dissolved transport offer this diver had joined — see CLAUDE.md's Leave Bubble
// section. Cleared by visiting the Transport tab (see TransportViewModel.checkAlert).
 bool get hasTransportAlert;// Same idea as hasTransportAlert, for a dissolved buddy group this diver had joined —
// cleared by visiting the Buddy tab (see BuddyViewModel.checkAlert).
 bool get hasBuddyAlert;// True when the diver's own car/buddy-group chat has a message they haven't seen —
...
// Bubble (unlike unreadCount); only clears once they actually visit that tab.
 bool get hasUnreadTransportMessages; bool get hasUnreadBuddyMessages; DateTime? get endDate; String? get description; String? get meetingPoint; int? get diveCountMin; int? get diveCountMax; int? get depthMinM; int? get depthMaxM; String? get minCertification; String? get bookingCode; int? get maxParticipants; String get bookingStatus;// Fixed at creation, no edit path — see CreateTripPage's toggle and TripPage's
// _PrivateJoinSection. Excluded from Explore either way; join goes through the same
// booking-code gate as a business trip.
 bool get isPrivate; String? get photoUrl;// Business fields — set when this trip was created from admin/, not the individual
// organizer flow. See CLAUDE.md's Business/dive centers section.
 String? get diveCenterId; int? get priceMinor; String get currency;// The trip's own external checkout page — where a diver actually pays to get a
...
// organizer-card-adjacent Book-now button and CLAUDE.md's Booking Code flow section).
 String? get bookingUrl;// Best-effort forward-geocode of location/meetingPoint at creation time — powers
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Trip&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.location, location) || other.location == location)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.joined, joined) || other.joined == joined)&&(identical(other.creatorUserId, creatorUserId) || other.creatorUserId == creatorUserId)&&(identical(other.participantCount, participantCount) || other.participantCount == participantCount)&&(identical(other.unreadCount, unreadCount) || other.unreadCount == unreadCount)&&(identical(other.hasTransportAlert, hasTransportAlert) || other.hasTransportAlert == hasTransportAlert)&&(identical(other.hasBuddyAlert, hasBuddyAlert) || other.hasBuddyAlert == hasBuddyAlert)&&(identical(other.hasUnreadTransportMessages, hasUnreadTransportMessages) || other.hasUnreadTransportMessages == hasUnreadTransportMessages)&&(identical(other.hasUnreadBuddyMessages, hasUnreadBuddyMessages) || other.hasUnreadBuddyMessages == hasUnreadBuddyMessages)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.description, description) || other.description == description)&&(identical(other.meetingPoint, meetingPoint) || other.meetingPoint == meetingPoint)&&(identical(other.diveCountMin, diveCountMin) || other.diveCountMin == diveCountMin)&&(identical(other.diveCountMax, diveCountMax) || other.diveCountMax == diveCountMax)&&(identical(other.depthMinM, depthMinM) || other.depthMinM == depthMinM)&&(identical(other.depthMaxM, depthMaxM) || other.depthMaxM == depthMaxM)&&(identical(other.minCertification, minCertification) || other.minCertification == minCertification)&&(identical(other.bookingCode, bookingCode) || other.bookingCode == bookingCode)&&(identical(other.maxParticipants, maxParticipants) || other.maxParticipants == maxParticipants)&&(identical(other.bookingStatus, bookingStatus) || other.bookingStatus == bookingStatus)&&(identical(other.isPrivate, isPrivate) || other.isPrivate == isPrivate)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.diveCenterId, diveCenterId) || other.diveCenterId == diveCenterId)&&(identical(other.priceMinor, priceMinor) || other.priceMinor == priceMinor)&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.bookingUrl, bookingUrl) || other.bookingUrl == bookingUrl)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,title,location,startTime,joined,creatorUserId,participantCount,unreadCount,hasTransportAlert,hasBuddyAlert,hasUnreadTransportMessages,hasUnreadBuddyMessages,endDate,description,meetingPoint,diveCountMin,diveCountMax,depthMinM,depthMaxM,minCertification,bookingCode,maxParticipants,bookingStatus,isPrivate,photoUrl,diveCenterId,priceMinor,currency,bookingUrl,latitude,longitude]);

@override
String toString() {
  return 'Trip(id: $id, title: $title, location: $location, startTime: $startTime, joined: $joined, creatorUserId: $creatorUserId, participantCount: $participantCount, unreadCount: $unreadCount, hasTransportAlert: $hasTransportAlert, hasBuddyAlert: $hasBuddyAlert, hasUnreadTransportMessages: $hasUnreadTransportMessages, hasUnreadBuddyMessages: $hasUnreadBuddyMessages, endDate: $endDate, description: $description, meetingPoint: $meetingPoint, diveCountMin: $diveCountMin, diveCountMax: $diveCountMax, depthMinM: $depthMinM, depthMaxM: $depthMaxM, minCertification: $minCertification, bookingCode: $bookingCode, maxParticipants: $maxParticipants, bookingStatus: $bookingStatus, isPrivate: $isPrivate, photoUrl: $photoUrl, diveCenterId: $diveCenterId, priceMinor: $priceMinor, currency: $currency, bookingUrl: $bookingUrl, latitude: $latitude, longitude: $longitude)';
}
...
@useResult
$Res call({
 String id, String title, String location, DateTime startTime, bool joined, String? creatorUserId, int participantCount, int unreadCount, bool hasTransportAlert, bool hasBuddyAlert, bool hasUnreadTransportMessages, bool hasUnreadBuddyMessages, DateTime? endDate, String? description, String? meetingPoint, int? diveCountMin, int? diveCountMax, int? depthMinM, int? depthMaxM, String? minCertification, String? bookingCode, int? maxParticipants, String bookingStatus, bool isPrivate, String? photoUrl, String? diveCenterId, int? priceMinor, String currency, String? bookingUrl, double? latitude, double? longitude
});
...
/// Create a copy of Trip
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? location = null,Object? startTime = null,Object? joined = null,Object? creatorUserId = freezed,Object? participantCount = null,Object? unreadCount = null,Object? hasTransportAlert = null,Object? hasBuddyAlert = null,Object? hasUnreadTransportMessages = null,Object? hasUnreadBuddyMessages = null,Object? endDate = freezed,Object? description = freezed,Object? meetingPoint = freezed,Object? diveCountMin = freezed,Object? diveCountMax = freezed,Object? depthMinM = freezed,Object? depthMaxM = freezed,Object? minCertification = freezed,Object? bookingCode = freezed,Object? maxParticipants = freezed,Object? bookingStatus = null,Object? isPrivate = null,Object? photoUrl = freezed,Object? diveCenterId = freezed,Object? priceMinor = freezed,Object? currency = null,Object? bookingUrl = freezed,Object? latitude = freezed,Object? longitude = freezed,}) {
...
as int,hasTransportAlert: null == hasTransportAlert ? _self.hasTransportAlert : hasTransportAlert // ignore: cast_nullable_to_non_nullable
as bool,hasBuddyAlert: null == hasBuddyAlert ? _self.hasBuddyAlert : hasBuddyAlert // ignore: cast_nullable_to_non_nullable
as bool,hasUnreadTransportMessages: null == hasUnreadTransportMessages ? _self.hasUnreadTransportMessages : hasUnreadTransportMessages // ignore: cast_nullable_to_non_nullable
as bool,hasUnreadBuddyMessages: null == hasUnreadBuddyMessages ? _self.hasUnreadBuddyMessages : hasUnreadBuddyMessages // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String location,  DateTime startTime,  bool joined,  String? creatorUserId,  int participantCount,  int unreadCount,  bool hasTransportAlert,  bool hasBuddyAlert,  bool hasUnreadTransportMessages,  bool hasUnreadBuddyMessages,  DateTime? endDate,  String? description,  String? meetingPoint,  int? diveCountMin,  int? diveCountMax,  int? depthMinM,  int? depthMaxM,  String? minCertification,  String? bookingCode,  int? maxParticipants,  String bookingStatus,  bool isPrivate,  String? photoUrl,  String? diveCenterId,  int? priceMinor,  String currency,  String? bookingUrl,  double? latitude,  double? longitude)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Trip() when $default != null:
return $default(_that.id,_that.title,_that.location,_that.startTime,_that.joined,_that.creatorUserId,_that.participantCount,_that.unreadCount,_that.hasTransportAlert,_that.hasBuddyAlert,_that.hasUnreadTransportMessages,_that.hasUnreadBuddyMessages,_that.endDate,_that.description,_that.meetingPoint,_that.diveCountMin,_that.diveCountMax,_that.depthMinM,_that.depthMaxM,_that.minCertification,_that.bookingCode,_that.maxParticipants,_that.bookingStatus,_that.isPrivate,_that.photoUrl,_that.diveCenterId,_that.priceMinor,_that.currency,_that.bookingUrl,_that.latitude,_that.longitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String location,  DateTime startTime,  bool joined,  String? creatorUserId,  int participantCount,  int unreadCount,  bool hasTransportAlert,  bool hasBuddyAlert,  bool hasUnreadTransportMessages,  bool hasUnreadBuddyMessages,  DateTime? endDate,  String? description,  String? meetingPoint,  int? diveCountMin,  int? diveCountMax,  int? depthMinM,  int? depthMaxM,  String? minCertification,  String? bookingCode,  int? maxParticipants,  String bookingStatus,  bool isPrivate,  String? photoUrl,  String? diveCenterId,  int? priceMinor,  String currency,  String? bookingUrl,  double? latitude,  double? longitude)  $default,) {final _that = this;
switch (_that) {
case _Trip():
return $default(_that.id,_that.title,_that.location,_that.startTime,_that.joined,_that.creatorUserId,_that.participantCount,_that.unreadCount,_that.hasTransportAlert,_that.hasBuddyAlert,_that.hasUnreadTransportMessages,_that.hasUnreadBuddyMessages,_that.endDate,_that.description,_that.meetingPoint,_that.diveCountMin,_that.diveCountMax,_that.depthMinM,_that.depthMaxM,_that.minCertification,_that.bookingCode,_that.maxParticipants,_that.bookingStatus,_that.isPrivate,_that.photoUrl,_that.diveCenterId,_that.priceMinor,_that.currency,_that.bookingUrl,_that.latitude,_that.longitude);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String location,  DateTime startTime,  bool joined,  String? creatorUserId,  int participantCount,  int unreadCount,  bool hasTransportAlert,  bool hasBuddyAlert,  bool hasUnreadTransportMessages,  bool hasUnreadBuddyMessages,  DateTime? endDate,  String? description,  String? meetingPoint,  int? diveCountMin,  int? diveCountMax,  int? depthMinM,  int? depthMaxM,  String? minCertification,  String? bookingCode,  int? maxParticipants,  String bookingStatus,  bool isPrivate,  String? photoUrl,  String? diveCenterId,  int? priceMinor,  String currency,  String? bookingUrl,  double? latitude,  double? longitude)?  $default,) {final _that = this;
switch (_that) {
case _Trip() when $default != null:
return $default(_that.id,_that.title,_that.location,_that.startTime,_that.joined,_that.creatorUserId,_that.participantCount,_that.unreadCount,_that.hasTransportAlert,_that.hasBuddyAlert,_that.hasUnreadTransportMessages,_that.hasUnreadBuddyMessages,_that.endDate,_that.description,_that.meetingPoint,_that.diveCountMin,_that.diveCountMax,_that.depthMinM,_that.depthMaxM,_that.minCertification,_that.bookingCode,_that.maxParticipants,_that.bookingStatus,_that.isPrivate,_that.photoUrl,_that.diveCenterId,_that.priceMinor,_that.currency,_that.bookingUrl,_that.latitude,_that.longitude);case _:
  return null;
...
class _Trip implements Trip {
  const _Trip({required this.id, required this.title, required this.location, required this.startTime, required this.joined, this.creatorUserId, this.participantCount = 0, this.unreadCount = 0, this.hasTransportAlert = false, this.hasBuddyAlert = false, this.hasUnreadTransportMessages = false, this.hasUnreadBuddyMessages = false, this.endDate, this.description, this.meetingPoint, this.diveCountMin, this.diveCountMax, this.depthMinM, this.depthMaxM, this.minCertification, this.bookingCode, this.maxParticipants, this.bookingStatus = 'open', this.isPrivate = false, this.photoUrl, this.diveCenterId, this.priceMinor, this.currency = 'DKK', this.bookingUrl, this.latitude, this.longitude});
...
// section. Cleared by visiting the Transport tab (see TransportViewModel.checkAlert).
@override@JsonKey() final  bool hasTransportAlert;
// Same idea as hasTransportAlert, for a dissolved buddy group this diver had joined —
// cleared by visiting the Buddy tab (see BuddyViewModel.checkAlert).
@override@JsonKey() final  bool hasBuddyAlert;
// True when the diver's own car/buddy-group chat has a message they haven't seen —
// distinct from the two Alert fields (a dissolved car/group). Survives just opening the
// Bubble (unlike unreadCount); only clears once they actually visit that tab.
@override@JsonKey() final  bool hasUnreadTransportMessages;
@override@JsonKey() final  bool hasUnreadBuddyMessages;
